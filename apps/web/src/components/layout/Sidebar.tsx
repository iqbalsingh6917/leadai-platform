...
const navItems = [
  ...
  { href: '/commerce/products', icon: ShoppingBag, label: 'Products' },
  { href: '/commerce/orders', icon: ShoppingBag, label: 'Orders' },
  { href: '/telephony', icon: Phone, label: 'Telephony' },
  { href: '/video-ai', icon: Video, label: 'Video AI' },
  { href: '/ai-marketplace', icon: Store, label: 'AI Marketplace' },
  ...
  { href: '/billing/global', icon: Globe, label: 'Global Plans' },
  { href: '/settings', icon: Settings, label: 'Settings' },
  { href: '/settings/byoai', icon: Brain, label: 'BYOAI' },
  { href: '/settings/sso', icon: Lock, label: 'Enterprise SSO' },
